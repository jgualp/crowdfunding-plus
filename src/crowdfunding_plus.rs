...
pub trait CrowdfundingPlus {
    ...
    #[only_owner]
    #[endpoint(setMaxDepositPerDonor)]
    ...
    fn set_max_target(&self, max_trg: BigUint) {
        self.max_target().set(max_trg);
    }

    #[only_owner]
    #[endpoint(setMinFund)]
    fn set_min_fund(&self, min_fnd: BigUint) {
        self.min_fund().set(min_fnd);
    }
